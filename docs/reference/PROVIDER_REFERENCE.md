...
| `bedrock-mantle` | `mantle` | Amazon Bedrock Mantle | API key | [link](https://aws.amazon.com/bedrock) | Use AWS SSO credentials or IAM keys with SigV4 signing. Set profile to your configured AWS CLI profile (e.g. boon-bedrock-codex). |
